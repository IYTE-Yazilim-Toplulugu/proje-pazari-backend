...
public class UserController {
    ...
    @PreAuthorize("isAuthenticated()")
    @SecurityRequirement(name = "Bearer Authentication")
    @Operation(summary = "Get current user profile", description = "Retrieves the authenticated user's complete profile with statistics")
    @ApiResponses(value = {
    ...
    public ResponseEntity<ApiResponse<UserProfileDTO>> getUserProfile(@PathVariable String userId) {
        ApiResponse<UserProfileDTO> response = getUserProfileHandler.handle(
