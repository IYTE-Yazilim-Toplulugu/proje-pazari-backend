 ...
 *
 * <p>Contains information about the deleted project, its owner, the number of pending
 * applications that were rejected as a result of the deletion, and the contact details
 * of affected applicants for notification purposes.
 *
