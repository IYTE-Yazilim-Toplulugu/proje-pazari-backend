...
@WebMvcTest(controllers = SearchController.class, properties = "spring.data.elasticsearch.enabled=true")
class SearchControllerTest {
        ...
        @MockitoBean
        private com.iyte_yazilim.proje_pazari.domain.interfaces.TokenBlacklistService tokenBlacklistService;

        @MockitoBean
        private com.iyte_yazilim.proje_pazari.infrastructure.security.config.RateLimitConfig rateLimitConfig;

        @MockitoBean
        private com.iyte_yazilim.proje_pazari.infrastructure.security.filter.IpBanFilter ipBanFilter;

        @MockitoBean
        private com.iyte_yazilim.proje_pazari.infrastructure.security.filter.MaintenanceModeFilter maintenanceModeFilter;
        ...
        void setUp() throws Exception {
                ...
                sampleProject = ProjectDocument.builder()
                                .id("1")
        ...
        class AdvancedSearchProjectsTests {
                ...
                void shouldPassCorrectParametersToMediator() throws Exception {
                        ...
                        ArgumentCaptor<SearchProjectsQuery> captor = ArgumentCaptor.forClass(SearchProjectsQuery.class);
        ...
        class SuggestProjectsTests {
                ...
                void shouldReturnSuggestionsWhenQueryIsValid() throws Exception {
                        List<String> suggestions = List.of("Java Spring Boot Project", "Java Backend Application");
