...
class RegisterUserHandlerTest {
        ...
        @Mock
        private IValidator<RegisterUserCommand> validator;
        ...
        void shouldRegisterUser_whenValidCommand() {
                ...
                RegisterUserResult expectedResult = new RegisterUserResult(
        ...
        void shouldReturnValidationError_whenNonIyteEmail() {
                // Given
                RegisterUserCommand command = new RegisterUserCommand("test@gmail.com", "password123", "John", "Doe");
