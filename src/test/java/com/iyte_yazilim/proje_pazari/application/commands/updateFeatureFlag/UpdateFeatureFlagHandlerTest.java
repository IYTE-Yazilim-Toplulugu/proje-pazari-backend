...
class UpdateFeatureFlagHandlerTest {
    ...
    @InjectMocks private UpdateFeatureFlagHandler handler;
    ...
    void shouldCreateNewFeatureFlag() {
        ...
        ApiResponse<Void> response =
                handler.handle(new UpdateFeatureFlagCommand("new_feature", true, "A new feature"));
        ...
        ApiResponse<Void> response =
                handler.handle(
                        new UpdateFeatureFlagCommand(
                                "existing_feature", true, "Updated description"));
    ...
    void shouldReturnValidationErrorForBlankKey() {
        ApiResponse<Void> response = handler.handle(new UpdateFeatureFlagCommand("", true, "desc"));
    ...
    void shouldReturnValidationErrorForNullKey() {
        ApiResponse<Void> response =
                handler.handle(new UpdateFeatureFlagCommand(null, true, "desc"));
